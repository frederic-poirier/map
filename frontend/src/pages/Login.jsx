  ...
  return (
    <div class="flex flex-col items-center justify-center p-4 h-80">
      ...
      <button
        ...
        class="flex items-center border-1 border-zinc-200 justify-center gap-3 px-5 py-3 rounded-xl font-medium hover:bg-zinc-100 transition-all duration-200 active:scale-[0.98]"
      >
